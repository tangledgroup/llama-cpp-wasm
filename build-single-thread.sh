...
export EMCC_CFLAGS="-O3 -msimd128 -DNDEBUG -s ASSERTIONS -s WASM=1 -s BUILD_AS_WORKER=1 -s EXPORT_ES6=1 -s MODULARIZE=1 -s INITIAL_MEMORY=1GB -s MAXIMUM_MEMORY=4GB -s ALLOW_MEMORY_GROWTH -s FORCE_FILESYSTEM=1 -s EXPORTED_FUNCTIONS=_main -s EXPORTED_RUNTIME_METHODS=callMain -s NO_EXIT_RUNTIME=1"
emmake make main
cd ../..
